    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .csrf()
                    .disable()
                .authorizeRequests()
                .mvcMatchers("/api/v1/folders/**", "/api/v1/folders")
                    .authenticated()
                .mvcMatchers(HttpMethod.GET, "/api/v1/notes")
                    .authenticated()
                .mvcMatchers(HttpMethod.PATCH, "/api/v1/notes/**/keys/**")
                    .authenticated()
                .mvcMatchers(HttpMethod.DELETE, "/api/v1/notes/**")
                    .authenticated()
                .anyRequest()
                    .permitAll()
                    .and()
